...
predict_time_at_distance(
  ...
  TAU = jack_profile_distance_correction$parameters$TAU,
  distance_correction = 
    jack_profile_distance_correction$parameters$distance_correction)
